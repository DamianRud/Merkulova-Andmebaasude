...
Iseseisvalt: tabel categories- loo protsedurid millega saab lisada,uuenda,kustutada
--kustuta tabeli
...
EXEC kustutaCategories 4;
EXEC kustutaCategories @id=5;



--tabeli uuenda 
CREATE PROCEDURE categories_Uuendab
@id int,
@uus_categoriesNimi varchar(30)
AS
BEGIN
SELECT * FROM categories;
UPDATE categories SET category_name = @uus_categoriesNimi
WHERE category_id = @id;
END;
-- kutse
EXEC categories_Uuendab 2, 'Püksid';
